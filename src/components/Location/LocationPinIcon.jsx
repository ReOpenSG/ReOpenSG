...
function LocationPinIcon({ usa }) {
  ...
  return (
    <div className={usa ? styles.pinIconUSA : styles.pinIcon}>
      <svg data-aos="zoom-in-down" data-aos-offset="10" data-aos-delay={usa ? '700' : '500'} data-aos-duration="1000" viewBox="0 0 28 60" fill="none" xmlns="http://www.w3.org/2000/svg">
